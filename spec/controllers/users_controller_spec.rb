...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :name => "Joe", :email => "Joe@example.net")
        third = Factory(:user, :name => "Mike", :email => "Mike@example.net")
  ...
  describe "Get 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "Deez what")
      get :show, :id => @user
...
#    end
  ...
  describe "GET 'edit'" do
    ...
    it "should have  a link to change the Gravatat" do
      get :edit, :id => @user
  ...
  describe "GET 'new'" do
    ...
    it "should redirect to root with create" do
      get :create, :id => @user
      response.should redirect_to(root_path)
    end
  end
